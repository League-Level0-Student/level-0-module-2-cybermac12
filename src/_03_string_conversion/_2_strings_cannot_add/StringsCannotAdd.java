...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
		...
		String fourAsString = JOptionPane.showInputDialog("plaese enter four");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
		String sixAsString = JOptionPane.showInputDialog("please enter six");
		...
		String fiveAsString = JOptionPane.showInputDialog("please enter five");
